...
public class TestSender implements CommandLineRunner{
	...
	public void run(String... arg0) throws Exception {
		System.out.println("TestSender - CommandLineRunner() called - 測試開始");
		if(template == null){
...
//    	System.out.println("CHANNEL_TO_BACKEND_QUEUE01 - [o] Sent -  data: " + data);
		template.convertAndSend(Util.QUEUE_NAME.BACKEND_TO_WEBCHAT_QUEUE, "foo 中文");
//		System.out.println("BACKEND_TO_WEBCHAT_QUEUE - [o] Sent -  data: " + data);
		template.convertAndSend(Util.QUEUE_NAME.BACKEND_TO_LINE_QUEUE, "foo 中文");
//		System.out.println("BACKEND_TO_LINE_QUEUE - [o] Sent -  data: " + data);
		template.convertAndSend(Util.QUEUE_NAME.BACKEND_TO_WECHAT_QUEUE, "foo 中文");
//		System.out.println("BACKEND_TO_WECHAT_QUEUE - [o] Sent -  data: " + data);
		template.convertAndSend(Util.QUEUE_NAME.BACKEND_TO_VOICE_QUEUE, "foo 中文");
